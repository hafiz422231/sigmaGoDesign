...
import ApprovalInformation from '../ApprovalInformation/ApprovalInformation';

const PendingApprovalDetailModal = ({onHide , ...props}) => {
  console.log(onHide)
    return (
              ...
              <div className="detail-header row">
                ...
                <div className="col-lg-4 col-xl-4 col-md-4 col-sm-12 col-12 m-0" >
                  ...
                  <div id="ticket-number">
                    <span id="incident-information">Incident Information</span>                    
                    <h4>10255</h4>
                ...
                <div className="col-lg-8 col-xl-8 col-md-8 col-sm-12 col-12 m-0">
                  ...
                  <div className="subject-details-wrapper">
                    ...
                    <div className="status">
                      ...
                      <span className="status-style">pending</span>
                    </div>
